...
<main class="main">
    ...
    <div class="creden-area de-padding" style="overflow:hidden;">
            ...
            <div class="row r-0">
                ...
                <div class="col-xl-5">
                    <div class="creden-right">
                        <div class="creden-right-info" style="background:transparent; border:1px solid grey;">
                            ...
                            <div class="creden-content">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="type" class="form-control input-style-2" name="web" placeholder="Subject">
                                            <span class="alert alert-error"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="file" class="form-control input-style-2" name="subject" placeholder="...">
                                            <span class="alert alert-error"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <textarea class="form-control input-style-2" name="message" placeholder="Your Description..."></textarea>
                                        <p style="color:black;">
                                        <input type="checkbox" name="agree">
                                        I agree to the use of personal information collected from myself or other 
                                            legitimate sources.
                                    </p>
                                    <p data-bs-toggle="modal" data-bs-target="#agree3-modal" style="cursor:pointer; color:#d10808;">Click here to view the privacy policy.</p>
...
<div class="modal fade" id="agree3-modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div>
            ...
            Mobile Number, Resume, Subject, Message
        </div>
        <div>
